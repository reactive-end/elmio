...
export class ManageVueltoUseCase {
   ...
   */
  async execute(requestId: string, dto: VueltoRequestDto): Promise<VueltoExecuteResult> {
    ...
    if (existing && existing.status === 'success') {
      throw new BadRequestException('Esta solicitud ya tiene un desembolso exitoso.')
    }
