...
export class PurchaseEntity {
  ...
  @Column({ name: 'purchaser_email', type: 'varchar', length: 255, nullable: true })
  purchaserEmail!: string | null

  @Column({ name: 'purchaser_document', type: 'varchar', length: 20, nullable: true })
  ...
  @Column({ name: 'marketplace_name', type: 'varchar', length: 255, nullable: true })
  marketplaceName!: string | null

  @Column({ name: 'amount_usd', type: 'decimal', precision: 10, scale: 2 })
  amountUsd!: number

  @Column({ name: 'amount_ves', type: 'decimal', precision: 15, scale: 2, nullable: true })
  amountVes!: number | null

  @Column({ name: 'exchange_rate', type: 'decimal', precision: 15, scale: 4, nullable: true })
