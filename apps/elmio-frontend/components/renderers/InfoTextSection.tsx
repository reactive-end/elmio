  ...
  return (
    <SectionContainer estilo={estilo} id={contenido.htmlId || undefined}>
      <div className="container mx-auto px-4">
        {contenido.titulo && (
          <h2 className="mb-3 font-bold" style={{
        ...
        {contenido.subtitulo && (
          <h3 className="mb-4 text-lg" style={{ color: estilo.subtituloColor, textAlign: estilo.tituloAlineacion as never }}>
            {contenido.subtitulo}
          </h3>
        )}
        {contenido.cuerpoHtml ? (
          <div className="prose max-w-none" style={{ color: estilo.cuerpoColor, textAlign: estilo.cuerpoAlineacion as never }}
            dangerouslySetInnerHTML={{ __html: contenido.cuerpoHtml }} />
        ) : contenido.descripcion ? (
          <div className="max-w-3xl leading-relaxed" style={{ color: estilo.cuerpoColor, fontSize: estilo.cuerpoTamano, textAlign: estilo.cuerpoAlineacion as never }}>
            {contenido.descripcion}
          </div>
        ) : null}
      </div>
