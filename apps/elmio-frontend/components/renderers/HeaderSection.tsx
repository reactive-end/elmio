          ...
          <div className="grid grid-cols-[auto_1fr_auto] items-center gap-4 px-4 py-3">
            ...
            <div className="flex items-center gap-3">
              <div className="hidden items-center overflow-hidden rounded-lg border border-gray-200 bg-gray-50 md:flex">
                <input className="h-10 w-48 bg-transparent px-3 text-sm focus:outline-none lg:w-64" placeholder="Buscar" />
                <button type="button" className="h-10 px-3 text-gray-500">
                  <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><circle cx="11" cy="11" r="8"/><path d="m21 21-4.3-4.3"/></svg>
                </button>
              </div>
              <div className="flex items-center gap-3" style={{ color: estilo.tituloColor || '#111827' }}>
                ...
                <button type="button" className="relative flex flex-col items-center gap-1">
                  <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><circle cx="8" cy="21" r="1"/><circle cx="19" cy="21" r="1"/><path d="M2.05 2.05h2l2.66 12.42a2 2 0 0 0 2 1.58h9.78a2 2 0 0 0 1.95-1.57l1.65-7.43H5.12"/></svg>
