...
const SOCIAL_ICONS: Record<string, string> = {
  ...
  youtube:
    'M2.5 17a24.12 24.12 0 0 1 0-10 2 2 0 0 1 1.4-1.4 49.56 49.56 0 0 1 16.2 0A2 2 0 0 1 21.5 7a24.12 24.12 0 0 1 0 10 2 2 0 0 1-1.4 1.4 49.55 49.55 0 0 1-16.2 0A2 2 0 0 1 2.5 17 M10 15l5-3-5-3z',
}
        ...
        <div className="grid gap-10 md:grid-cols-4">
          ...
          <div className="grid gap-8 md:col-span-3 md:grid-cols-3">
            {columnas.map((col) => {
              ...
              return (
                <div key={col.id}>
                  <p className="mb-3 font-semibold" style={{ color: estilo.tituloColor }}>
                    {col.titulo}
                  </p>
                  {social ? (
                    ...
                    <div className="flex flex-col gap-2">
                      {col.enlaces.map((link) => (
                        <Link
                          ...
                          style={{ color: estilo.cuerpoColor }}
                        >
                          {link.texto}
                        </Link>
                      ))}
        ...
        <div className="mt-10 flex flex-col items-center justify-between gap-4 border-t border-white/10 pt-6 md:flex-row">
          ...
          {contenido.enlaceBoton && (
            <div className="flex gap-4 text-sm">
              {[
                { id: 'terms', texto: 'Terminos', href: '/terminos' },
                { id: 'privacy', texto: 'Privacidad', href: '/privacidad' },
              ].map((link) => (
                <Link
                  key={link.id}
                  href={link.href}
