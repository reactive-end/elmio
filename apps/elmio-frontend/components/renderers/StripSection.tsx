            ...
            <div key={slide.id ?? idx} className="relative h-full w-full shrink-0">
              {slide.imagen ? (
                ...
                <div
                  ...
                  style={{
                    backgroundColor:
                      estilo.colorFondo !== 'transparente' ? estilo.colorFondo : '#1E40AF',
                  }}
                />
              )}
                ...
                <div className="max-w-3xl text-center">
                  ...
                  {slide.texto && (
                    <p
                      ...
                      style={{ color: estilo.cuerpoColor || 'rgba(255,255,255,0.9)' }}
                    >
                      {slide.texto}
                    </p>
                  )}
                  {slide.textoBoton && (
                    <button
                      type="button"
                      className="inline-block rounded-xl px-5 py-2 font-medium transition-colors"
                      style={{
                        backgroundColor: estilo.botonColorFondo || '#FBBF24',
                        color: estilo.botonColorTexto || '#1E40AF',
                        borderRadius: estilo.botonRedondez || 8,
                      }}
                    >
                      {slide.textoBoton}
                    </button>
