/**
 * @fileoverview Componente de Paso 4: Carga de Documentos para La Mundial de Seguros.
 * @description Provee áreas drag-and-drop para cargar cédula y título de propiedad.
 * @module components/molecules/MundialRCVSteps/Step4Documents
 */
          ...
          <div className="flex items-center gap-3 min-w-0">
            ...
            <div className="min-w-0">
              ...
              <p className="text-xs text-body-muted mt-0.5">
                {formatSize(file.size)} &bull; {file.type || 'Documento'}
              </p>
            </div>
          </div>
          <button
        ...
        >
          ...
          <div>
            ...
            <p className="text-xs text-body-muted mt-1">
              Arrastre o seleccione archivo (JPG, PNG o PDF. Máx 10MB)
            </p>
          </div>
      ...
      <div className="flex items-center gap-3 border-b border-gray-100 pb-4">
        ...
        <div>
          ...
          <p className="text-xs text-body-muted">
            Adjunte la cédula del asegurado y el título de propiedad del vehículo.
          </p>
        </div>
      </div>
